...
public class busBookingPOJO {
    ...
    public busBookingPOJO ( ) {
    }

    public busBookingPOJO (Long id, String fullName, long mobile, int age, String email, String address) {
        this.id = id;
